#yolov3.py - konstruisanje YOLO V3 modela
...
def parse_cfg(cfgfile):
    #Parsiranje yolo v3 konfiguracionog fajla.

    #Parametri:
    #    cfgfile: Ime i putanja do konfiguracione datoteke

    #Povratna vrednost:
    #    blocks: Rečnik koji sadrži blokove definisane u konfiguracionom fajlu

    with open(cfgfile, 'r') as file:
        # Smeštanje redova datoteke u listu 
        lines = [line.rstrip('\n') for line in file if line != '\n' and line[0] != '#']
    holder = {}
    blocks = []
    # parsiranje linija i stvaranje blokova/slojeva u obliku rečnika
    for line in lines:
        if line[0] == '[':
